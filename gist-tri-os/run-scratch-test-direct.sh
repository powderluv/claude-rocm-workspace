...
# the flaky KIQ activation) then run. DIRECT-MEC (no MES) scratch test: per-dispatch SET_SH_REG authoritative (tinygrad model)
...
export ROCR_MACOS_AQL_ENABLE_SCRATCH=1 \
